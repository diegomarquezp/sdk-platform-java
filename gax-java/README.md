...
```Groovy
compile 'com.google.api:gax:2.72.2-rc1',
  'com.google.api:gax-grpc:2.72.2-rc1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "2.72.2-rc1"
libraryDependencies += "com.google.api" % "gax-grpc" % "2.72.2-rc1"
```
